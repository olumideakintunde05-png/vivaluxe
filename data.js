...
/* The client's official 10 product categories. `key` is the exact
...
const WHY_US = [
  { title:'Quality Materials', text:'Jewelry crafted with care, made to last.',
...
/* Default WhatsApp number and contact email — editable live from the
   ...
   delivery fees above. */
let WHATSAPP_NUMBER = '+2349121461550';
...
const INFO_PAGES = {
  payment: {
    ...
    body: `
      ...
      <p><strong>Paystack</strong> — Pay securely by card or bank transfer through Paystack's checkout.</p>
      <p><strong>Flutterwave</strong> — Pay securely by card, bank transfer, or USSD through Flutterwave's checkout.</p>
    `
  },
  about: {
    title: 'About Us',
  ...
  terms: {
    ...
    body: `
      ...
      <p>All orders must be fully paid before processing. Payments are securely accepted through Paystack, Flutterwave, and Moniepoint.</p>
      <h4>Delivery</h4>
